...
knitr::opts_chunk$set(message = F, warning = F, echo = T, cache = F, dev.args = list(family = 'serif'), dpi = 400, tidy.opts=list(width.cutoff=80), tidy=TRUE)
...
```{r thrplotex, fig.height = 3.5, fig.width = 7}
# load the package
library(tbeptools)
