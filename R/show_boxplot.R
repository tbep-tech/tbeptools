...
show_boxplot <- function(epcdata, param = c('chla', 'la'),  yrsel = NULL, yrrng = c(1975, 2025), ptsz = 0.5, bay_segment = c('OTB', 'HB', 'MTB', 'LTB'),
                         trgs = NULL, family = 'sans', labelexp = TRUE, txtlab = TRUE, partialyr = FALSE, points = TRUE){
