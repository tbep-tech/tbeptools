...
#' }
#' @details
#' Daily precipitation data from 1995-2023, provided by the Southwest Florida Water Management District, were downloaded at the pixel level and averaged to the catchment level for key Enterococcus sampling stations. Generated by \code{data-raw/catchprecip-raw.R} (view on github: \url{https://github.com/tbep-tech/tbeptools/blob/master/data-raw/catchprecip-raw.R})
