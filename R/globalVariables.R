globalVariables(c("Chlorophyll_aQ", "Latitude", "Longitude", "SampleTime", "SampleDepth",
                  ...
                  'AMBIGroupID', 'TBAMBIGroupID', 'AMBIListSource', 'TotalGroupCount',
                  'PercentG1', 'PercentG2', 'PercentG3', 'PercentG4', 'PercentG5',
                  'BC', 'AMBI', 'TBAMBI', 'AMBICat', 'TBAMBICat',
                  'SitePollutionClassification', 'BioticIndex', 'DominatingEcologicalGroup',
                  'BenthicCommunityHealth', 'G1', 'G2', 'G3', 'G4', 'G5', 'n_records',
                  'ambicatid',
