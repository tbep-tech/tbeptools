...
#' }
read_importphyto <- function(xlsx, na = '', download_latest_epchc = FALSE, connecttimeout = 10, tryurl = FALSE, ...){

  # download latest and compare with current if exists
  read_dlcurrent(xlsx, download_latest_epchc, connecttimeout = connecttimeout, tryurl = tryurl, phyto = TRUE)
