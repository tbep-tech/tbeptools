...
#' @importFrom dplyr %>%
#'
#' @details The function imports a JSON file from the USF Water Atlas.  If \code{training = TRUE}, a dataset from the TBEP training survey is imported from \url{https://tampabay.wateratlas.usf.edu/seagrass-transect-data-portal/api/assessments/training}.  If \code{training = FALSE}, the entire transect survey database is imported from \url{https://tampabay.wateratlas.usf.edu/seagrass-transect-data-portal/api/assessments/all__use-with-care}.
#'
