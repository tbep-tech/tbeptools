...
External package libraries in R can be used to plot the time series data.  Not specifying these arguments will return results for the entire period of record. 
