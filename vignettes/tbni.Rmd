...
# Jabbrev::bib_scrp(here('vignettes', 'tbni.Rmd'), bib_new = here('vignettes', 'tbnirefs.bib'), ext_bib = 'https://raw.githubusercontent.com/tbep-tech/tbep-refs/master/bibs.bib')
...
The `read_importfim()` function can also return a simple features object of sampled stations in the raw FIM data by setting \code{locs = TRUE}.  These data are matched to the appropriate bay segments for tabulating TBNI scores.      

```{r, results = 'hide', echo = F}
csv <- 'fimdata.csv'
```
```{r}
fimstattions <- read_importfim(csv, download_latest = TRUE, locs = TRUE)
