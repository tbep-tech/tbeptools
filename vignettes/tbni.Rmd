...
# spelling::spell_check_files(here("vignettes", "tbni.Rmd"))
```
...
Each of the plots can also be produced as [plotly](https://plotly.com/r/) interactive plots by setting `plotly = TRUE` inside ach function. 
