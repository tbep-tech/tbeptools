...
```{r outints, fig.cap = 'Outcomes for annual estimates of water quality are assigned an integer value from zero to three depending on both magnitude and duration of the exceedence.', out.width = '80%', echo = F}
include_graphics('outints.png')
```
...
```{r matrixcats, out.width = '80%', fig.cap = "Management action categories assigned to each bay segment and year based on chlorophyll and light attenuation outcomes.", echo = F}
