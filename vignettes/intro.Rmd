...
knitr::include_graphics(here('docs/articles', 'tb_map.png'))
```
...
knitr::include_graphics(here('docs/articles', 'readauto.png'))
```
...
knitr::include_graphics(here('docs/articles', 'helpfileex.PNG'))
```
...
knitr::include_graphics(here('docs/articles', 'outints.PNG'))
```
...
knitr::include_graphics(here('docs/articles', 'matrixcats.PNG'))
```
