...
Attainment outcomes for a single year can be returned in tabular format with `anlz_yrattain()`.  This table also show segment averages for chlorophyll and light attenuation, including the associated target. 
