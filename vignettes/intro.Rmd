...
<center><img src="outints.PNG" alt="Outcomes for annual estimates of water quality are assigned an integer value from zero to three depending on both magnitude and duration of the exceedence." width="80%" />
<p class="caption">
...
<center><img src="matrixcats.PNG" alt="Management action categories assigned to each bay segment and year based on chlorophyll and light attenuation outcomes." width="80%" />
<p class="caption">
