test_that("Checking anlz_tbbiscr", {
  ...
  expect_equal(result, structure(list(StationID = 12744L, StationNumber = "17DH06-6",
                                      AreaAbbr = "MTB", FundingProject = "TBEP", ProgramID = 18L,
                                      ProgramName = "Dredge Hole Study", Latitude = 27.822125,
