test_that("Checking results for anlz_transectave", {
  ...
  results <- results[1, ]
  expect_equal(results, structure(list(bay_segment = structure(1L, .Label = c("All",
                                       ...
                                       foest = 58.0035143354157, focat = structure(2L, .Label = c("#EE7600",
                                                                                                           ...
                                                                                                           "tbl_df", "tbl", "data.frame"), row.names = c(NA, -1L), groups = structure(list(
                                                                                                             bay_segment = structure(1L, .Label = c("All", "OTB",
...
test_that("Checking results for anlz_transectave, rev = T", {
  ...
  expect_equal(results, structure(list(
    bay_segment = structure(1L, .Label = c("BCB", "LTB", "MTB", "HB", "OTB", "All"), class = "factor"),
    yr = 1998,
    ...
    groups = structure(list(bay_segment = structure(1L, .Label = c("BCB", "LTB", "MTB", "HB", "OTB", "All"),
