test_that("Checking results for anlz_tbbimed", {
  ...
  expect_equal(results, structure(list(bay_segment = structure(5L, .Label = c("HB", "OTB",
                                       ...
                                       yr = 2018, Degraded = 0, `Empty Sample` = 0, Healthy = 0.8,
                                       Intermediate = 0.2, TBBICat = structure(3L, .Label = c("Poor",
                                                                                              "Fair", "Good"), class = "factor")), row.names = c(NA, -1L
                                                                                              ), groups = structure(list(.rows = structure(list(1L), ptype = integer(0), class = c("vctrs_list_of",
