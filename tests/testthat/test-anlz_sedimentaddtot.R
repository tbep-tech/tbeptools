...
test_that("Checking show_sedimentmap sanity checks", {
  ...
  expect_error(show_sedimentaddtot(sedimentdata, param = 'Arsenic', yrrng = c(1990, 2030)))
  expect_error(show_sedimentaddtot(sedimentdata, param = 'Arsenic', yrrng = c(2001, 1994)))
  expect_error(show_sedimentaddtot(sedimentdata, param = 'asdf', yrrng = c(1993, 2000)))
