test_that("Checking anlz_tdlcrkindic", {
  ...
  expect_equal(result, structure(list(id = 564L, wbid = "2026", JEI = "SC37", Name = "",
                                      class = "3M", year = 2008, CHLAC = 2.80886253685455, COLOR = NA_real_,
                                      ...
                                      tp2_tsi = 56.7917082115845, nut_tsi = 46.9299813721713, tsi = 39.3010038798182), row.names = 1025L, class = "data.frame"))
})
