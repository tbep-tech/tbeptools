...
info about contributing to this, please see the [**development
contributing guide**](https://rstd.io/tidy-contrib).
...
Please note that the tbeptools project is released with a [Contributor
Code of
Conduct](https://tbep-tech.github.io/tbeptools/CODE_OF_CONDUCT.md). By
